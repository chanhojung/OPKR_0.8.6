    ...
    if CS.acc_active and not CS.out.brakePressed:
      if (CS.out.vEgo * CV.MS_TO_KPH)+5 < 30 : #GAP_DIST 1칸 만들기
        ...
        if CS.cruiseGapSet == 1.0:
          self.cruise_gap_auto_switch_timer = 0
      elif (CS.out.vEgo * CV.MS_TO_KPH)+5 < 60 :#GAP_DIST 2칸 만들기
        self.cruise_gap_auto_switch_timer += 1
        ...
        if CS.cruiseGapSet == 2.0:
          self.cruise_gap_auto_switch_timer = 0          
      elif (CS.out.vEgo * CV.MS_TO_KPH)+5 < 100 :#GAP_DIST 3칸 만들기
        self.cruise_gap_auto_switch_timer += 1
        ...
        if CS.cruiseGapSet == 3.0:
          self.cruise_gap_auto_switch_timer = 0          
      elif (CS.out.vEgo * CV.MS_TO_KPH)+5 >= 100: #GAP_DIST 4칸 유지들기
        self.cruise_gap_auto_switch_timer += 1
